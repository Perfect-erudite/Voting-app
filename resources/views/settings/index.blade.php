    ...
    <section class="content-header">
        ...
        <h1 class="pull-right">
            @if(isset($settings) && count($settings) > 0)
                <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('settings.edit', 1) !!}"><i class="glyphicon glyphicon-edit"></i> Update Settings</a>                
           @else
